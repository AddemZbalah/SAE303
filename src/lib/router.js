...
class Router {
  ...
  renderContent(content, route, path) {
    console.log("renderContent called with:", content, "route:", route, "path:", path);
    console.log("route.useLayout:", route.useLayout);
    const isFragment = content instanceof DocumentFragment;
    const isElement = content instanceof HTMLElement;
    console.log("isFragment:", isFragment, "isElement:", isElement);
    ...
    if (route.useLayout) {
      ...
      if (layoutFn) {
        ...
        console.log("Inserting layout into DOM...");
        this.root.innerHTML = '';
